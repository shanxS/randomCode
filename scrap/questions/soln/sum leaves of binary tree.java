...
public class Main
{
    public static void main(String[] er)
    {
        ...
        LeafSummer ilo = new LeafSummer();
        System.out.print(ilo.sum(bt.getHead()));
    }
}
...
class LeafSummer
{
    ...
    private void sumLeaves(Node node)
    {
        if (node == null)
        {
            return;
        ...
        sumLeaves(node.getLeft());
        sumLeaves(node.getRight());
    }
}
