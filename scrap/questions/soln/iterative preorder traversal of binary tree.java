...
class IterativePreOrder
{
    ...
    public void print(Node head)
    {
        ...
        while(stack.size() > 0)
        {
            Node currentTopNode = stack.pop();
            System.out.print(currentTopNode.getValue() + " ");

            if (currentTopNode.getRight() != null)
            {
                stack.push(currentTopNode.getRight());
            }
            if(currentTopNode.getLeft() != null)
            {
                stack.push(currentTopNode.getLeft());
            }
        }
    }
}
