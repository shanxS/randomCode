...
class BoundaryPrinter
{
    ...
    public void printBondary()
    {
        ...
        while(nodes.size() > 0)
        {
            ...
            if (staleCount > 1)
            {
                rightNodes.add(nodes.get(staleCount - 1));
            }
            ...
            while(staleCount > 0)
            {
                ...
                if (node.getLeft() != null)
                {
                    ...
                    if (isLeafNode(node.getLeft()))
                    {
                        //leftNodes.add(node.getLeft());
                    }
                }
                ...
                if (node.getRight() != null)
                {
                    ...
                    if (isLeafNode(node.getRight()))
                    {
                        //leftNodes.add(node.getRight());
                    }
                }
                --staleCount;
            }
